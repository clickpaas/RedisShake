...
var subCommands = []string{"aof_reader", "rdb_reader", "scan_reader", "sync_reader",
	...
	"filter", "advanced", "module","file_writer"}
...
command_writer: redis_writer, redis_writer.sentinel`,
	...
	// eg:redis-shake-cmd redis_writer -a 127.0.0.1:6379 aof_reader -f appendonly.aof
	// cmdIndex        5                             0
...
func buildFileWriter() (*viper.Viper, *cobra.Command) {
	vp := viper.New()
